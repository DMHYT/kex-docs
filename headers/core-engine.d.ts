                    ...
                    export module ui {
                        export module container {
                            ...
                            export class Container extends java.lang.Object implements UiAbstractContainer, recipes.workbench.WorkbenchField {
                                 ...
                                 * doesn't exist
                                 */
                                getBinding<T=any>(elementName: string, bindingName: string): Nullable<elements.UIElement | android.graphics.Rect | T>;
                    ...
                    export module ui {
                        export module container {
                            export class UiAbstractContainer extends java.lang.Object {
                                ...
                                addElementInstance(element: elements.UIElement, name: string): void;
                                close(): void;
                                getBinding<T=any>(element: string, bindingName: string): Nullable<elements.UIElement | android.graphics.Rect | T>;
